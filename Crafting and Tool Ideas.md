...
* 1 Stick + 1 Lumostone = 1 Lumostorch
* 1 Bronze Bar + 4 Glass = 1 Bronze Lamp
* 2 Log = 1 Wooden Chest
...
* 10 Copper Ore = 1 Copper Bar
* 9 Copper Ore + 1 Tin Ore = 1 Bronze Bar
* 15 Iron Ore = 1 Iron Bar
* 12 Pure Iron Ore + 3 Coal Ore = 1 Steel Bar
* 20 Silver Ore = 1 Silver Bar
* 30 Gold Ore = 1 Gold Bar
* 50 Platinum Ore = 1 Platinum Bar
* 60 Mithril Ore + 20 Coal Ore = 1 Mithril Bar
* 60 Ozathinum Ore + 30 Lumosite Ore + 2 Mithril Bar + 1 Lava = 1 Ozathinum Bar
* 60 Torzite Ore + 30 Lumosite Ore + 4 Ozathinum Bar + 1 Lava = 1 Torzite Bar
* 100 Etherealite Ore + 50 Lumosite Ore + 6 Torzite Bar + 10 Platinum Bar + 20 Gold Bar + 30 Silver + 1 Lava = 1 Etherealite Bar
* 10 Lumosite = 1 Lumostone
* 1 Sand = 1 Glass
...
* 3 Canola Flower = 1 Canola Oil
* 3 Flaxseed = 1 Flour
* 1 Fish = 2 Fish Meat
* 1 Squid = 3 Squid Chunks
* 1 Clam = 1 Clam Meat + 2 Clam Shell + \[10% chance for 1 Pearl or 1% chance for Black Pearl]

Cooking (Range)

* 3 Flour + 2 Canola Oil + 1 Water = Bread
* 1 Fish Meat + 1 Squid Chunk + 1 Clam Meat + Sea Weed + 1 Stick = Sea Kabab
* 4 Fish Meat + 1 Mushroom = Fish Stew
